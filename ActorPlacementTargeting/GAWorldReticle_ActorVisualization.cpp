...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GAWorldReticle_ActorVisualization)
...
void AGAWorldReticle_ActorVisualization::InitializeReticleVisualizationInformation(AActor* InTargetingActor, AActor* VisualizationActor, UMaterialInterface *VisualizationMaterial)
{
...
void AGAWorldReticle_ActorVisualization::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
